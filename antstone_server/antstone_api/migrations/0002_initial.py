...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='imagenavance',
            name='avance_de_tarea',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imagenes', to='antstone_api.avancedetarea'),
        ),
        migrations.AddField(
            model_name='obra',
            name='director',
